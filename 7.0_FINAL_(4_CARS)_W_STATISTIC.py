...
# cap.set(cv2.CAP_PROP_BRIGHTNESS, 1.55)cap.set(cv2.CAP_PROP_AUTO_EXPOSURE, 0.75)
    ...
    for i in range(len(cross_letter)):
        for j in range(1, 4):
            ...
            if order_in_cross.find('BL')>=5:
                decision_var = order_in_cross[3] + order_in_cross[8]
                # print(decision_var)
                if decision_var == 'lr' or decision_var == 'fr':
                ...
                if decision_var == 'ff':
                    if (m_unit_blue[n_blue][1][1] != m_unit_blue[n_blue + 1][1][1] and m_unit_yellow[n_yellow][1][1] != m_unit_yellow[n_yellow + 1][1][1]) \
                            or (m_unit_blue[n_blue][1][1] != m_unit_blue[n_blue + 1][1][1] and m_unit_purple[n_purple][1][1] != m_unit_purple[n_purple + 1][1][1]):  # Т.е.следующие letter of cross совпадают
                        global_msg_blue = 's'
                        CASE_SUBJECT = decision_var
